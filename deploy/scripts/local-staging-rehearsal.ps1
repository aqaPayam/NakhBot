...
try {
  ...
  $env:NAKH_R2_CLEANUP_ACCESS_KEY_REF = "NAKH_R2_CLEANUP_ACCESS_KEY"
  $env:NAKH_R2_CLEANUP_SECRET_KEY_REF = "NAKH_R2_CLEANUP_SECRET_KEY"
  $env:NAKH_MEDIA_CACHE_PURGE_ENABLED = "false"
  $env:NAKH_MEDIA_CLEANUP_ENABLED = "false"
  $env:NAKH_MEDIA_ORPHAN_RECONCILIATION_ENABLED = "false"
  $env:NAKH_MEDIA_ORPHAN_GRACE_MS = "86400000"
  $env:NAKH_MEDIA_CDN_HOST = "disabled-until-m2.invalid"
  $env:NAKH_MEDIA_SIGNING_KEY_REF = "NAKH_MEDIA_SIGNING_KEY"
  $env:NAKH_MEDIA_AUDIENCE_KEY_ID = "audience-v1"
  $env:NAKH_MEDIA_AUDIENCE_KEY_REF = "NAKH_MEDIA_AUDIENCE_KEY"
